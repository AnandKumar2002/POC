...
const TentForm: React.FC = () => {
  ...
  useEffect(() => {
    formik.setValues(prev => ({
      ...
      additionalTravelers: Array.from(
        ...
        (_, i) => prev.additionalTravelers[i] || {
          name: "",
          age: "",
          gender: "",
        }
  ...
  const getError = (field: keyof AdditionalTravelers, index: number) => {
    const errorsArray = formik.errors.additionalTravelers as FormikErrors<AdditionalTravelers>[] | undefined;
    ...
    <div>
      <Container>
                  ...
                  {isXs ? (
                    ...
                    formik.values.additionalTravelers.map((traveler, index) => (
                      ...
                      >
                        ...
                        />
                        <FormControl fullWidth>
                          <InputLabel id={`additionalTravelers-${index}-gender-label`}>
                            {
                              <span>
                                Gender <span style={{ color: "red" }}>*</span>
                              </span>
                          ...
                          {formik.touched.additionalTravelers?.[index]?.gender &&
                    ...
                    <TableContainer component={Paper}>
                      <Table>
                        <TableHead style={{ background: "#a81f10" }}>
                          <TableRow>
                            <TableCell
                              sx={{ width: 50 }}
        ...
        <Dialog open={phoneVerifyModal}>
          <PhoneVerifyModel mobile={primaryTraveler.mobile}
